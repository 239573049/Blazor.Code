...
export class LanguageServiceContribution extends Disposable implements ClientAppContribution {
  ...
  onStart() {
    // lsif registration
    this.addDispose(
      this.simpleLanguageService.registerHoverProvider({ pattern: '**/*.{js,jsx,ts,tsx,java,go,razor}' }, {
    ...
    this.addDispose(
      this.simpleLanguageService.registerDefinitionProvider({ pattern: '**/*.{js,jsx,ts,tsx,java,go,razor}' }, {
    ...
    this.addDispose(
      this.simpleLanguageService.registerReferenceProvider({ pattern: '**/*.{js,jsx,ts,tsx,java,go,razor}' }, {
